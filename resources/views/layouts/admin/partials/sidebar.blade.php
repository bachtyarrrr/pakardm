<aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand sidebar-brand-sm">
        <a href="{{ route('admin.dashboard') }}">DES</a>
    </div>
    <ul class="sidebar-menu">
      ...
      <a href="{{route('admin.dashboard')}}" class="nav-link"><i class="fas fa-home"></i><span>Dashboard</span></a>
        ...
        <li class="{{ $title == 'Decision Tree' ? 'active' : '' }}">
            <a href="{{ route('admin.decision-tree')}}" class="nav-link"><i class="fas fa-network-wired"></i><span>Decision Tree</span></a>
        </li>
