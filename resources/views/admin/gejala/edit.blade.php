            ...
            <form action="{{route('admin.gejala.update', $gejala->id)}}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori" value="{{ $gejala->kategori }}" placeholder="Masukkan Kategori" autocomplete="off">
                        @error('kategori')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
