        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Detail {{ $title }} <span style="text-transform: capitalize">{{ $penyakit->nama }}</span></h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="text-transform: capitalize">{{ $penyakit->nama }}</p>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('admin.penyakit.index') }}" class="btn btn-primary"><i
